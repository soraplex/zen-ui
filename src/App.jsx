  ...
  return (
    ...
    >
      <div style={{ maxWidth: "800px", width: "100%" }}>
        ...
        {/* Zen Colors */}
        <DemoContainer title="Zen Colors — Calm, Peaceful">
          <Button color="stone.500">Stone</Button>
          <Button color="bamboo.500">Bamboo</Button>
          <Button color="sage.500">Sage</Button>
          <Button color="mist.500">Mist</Button>
        ...
        {/* Chi Colors */}
        <DemoContainer title="Chi Colors — Energy, Vitality">
          <Button color="life.500">Life</Button>
          <Button color="fire.500">Fire</Button>
          <Button color="sun.500">Sun</Button>
          <Button color="water.500">Water</Button>
        ...
        {/* Sizes (using Zen) */}
        <DemoContainer title="Sizes">
          <Button color="stone.500" size="sm">
            Small
          </Button>
          <Button color="stone.500" size="md">
            Medium
          </Button>
          <Button color="stone.500" size="lg">
            Large
          </Button>
        </DemoContainer>
        ...
        {/* Outline (using Zen) */}
        <DemoContainer title="Outline">
          <Button color="stone.500" variant="outline">
            Stone
          </Button>
          <Button color="bamboo.500" variant="outline">
            Bamboo
          </Button>
          <Button color="sage.500" variant="outline">
            Sage
          </Button>
          <Button color="mist.500" variant="outline">
            Mist
          </Button>
        </DemoContainer>
        ...
        {/* Ghost (using Zen) */}
        <DemoContainer title="Ghost">
          <Button color="stone.500" variant="ghost">
            Stone
          </Button>
          <Button color="bamboo.500" variant="ghost">
            Bamboo
          </Button>
          <Button color="sage.500" variant="ghost">
            Sage
          </Button>
          <Button color="mist.500" variant="ghost">
            Mist
          </Button>
        </DemoContainer>

        {/* Stone Shades */}
        <DemoContainer title="Stone Shades (50 - 900)">
          <Button color="stone.50" style={{ color: "#44403c" }}>
            50
          </Button>
          <Button color="stone.100">100</Button>
          <Button color="stone.200">200</Button>
          <Button color="stone.300">300</Button>
          <Button color="stone.400">400</Button>
          <Button color="stone.500">500</Button>
          <Button color="stone.600">600</Button>
          <Button color="stone.700">700</Button>
          <Button color="stone.800">800</Button>
          <Button color="stone.900">900</Button>
        </DemoContainer>

        {/* Disabled */}
        <DemoContainer title="Disabled">
          <Button color="stone.500" disabled>
            Disabled
          </Button>
          <Button color="life.500" disabled>
            Disabled
          </Button>
          <Button color="fire.500" disabled>
            Disabled
          </Button>
        </DemoContainer>
        ...
        {/* Mobile Responsive */}
        <DemoContainer title="Mobile Responsive">
          <Button color="water.500" size={["sm", "md", "lg"]}>
            Responsive
          </Button>
          <Button color="life.500" fullWidth size={["sm", "md"]}>
            Full Mobile
          </Button>
          <Button color="fire.500" size="lg">
            Static
          </Button>
        </DemoContainer>
        ...
        {/* Badge Sizes */}
        <DemoContainer title="Badge Sizes">
          <Badge color="stone.500" size="sm">
            Small
          </Badge>
          <Badge color="stone.500" size="md">
            Medium
          </Badge>
          <Badge color="stone.500" size="lg">
            Large
          </Badge>
        </DemoContainer>
        ...
        {/* Alert - Using Chi colors for status */}
        <DemoContainer title="Alert">
          <div style={{ width: "100%" }}>
        ...
        {/* Box - Using Zen backgrounds */}
        <DemoContainer title="Box">
          <div style={{ padding: "12px", backgroundColor: "#f5f5f4", borderRadius: "4px" }}>
            <span style={{ color: "#57534e" }}>Box with Stone background</span>
          </div>
        </DemoContainer>
        ...
        <DemoContainer title="Flex Layout">
          <div style={{ display: "flex", gap: "8px", width: "100%" }}>
            <div
              style={{ flex: 1, padding: "12px", backgroundColor: "#f5f5f4", borderRadius: "4px", textAlign: "center" }}
            >
              Box 1
            </div>
            <div
              style={{ flex: 1, padding: "12px", backgroundColor: "#e7e5e4", borderRadius: "4px", textAlign: "center" }}
            >
              Box 2
            </div>
          </div>
